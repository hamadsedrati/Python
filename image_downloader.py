...
try:
    ...
    print(f"\n[{red}ERROR{reset}] Please enter the URL.")
    exit()
    ...
    print(
        f"\n[ {red}ERROR{reset} ] Connection Error, Please check your internet connection and check that the url is valid and try again."
    )
    exit()

except requests.Timeout:
    print(
        f"\n[ {red}ERROR{reset} ] Connection Timed out, Please check your internet connection and try again."
    )
    exit()
